  ...
  public function fetchSocial($btn, $options)
  {
    ...
    switch ($options['content'][$btn]['item-type']) {
      case 'image':
        switch ($btn) {
          case 'facebook':
            $button = "<a target='_blank' class='shared-fb''><img src='".$options['content'][$btn]['value']."' class='".$options['class-prefix']. $options['content'][$btn]['class'] ."'" . $size . "></a>";
            break;
          case 'twitter':
      ...
      case 'text':
        switch ($btn) {
          case 'facebook':
            $button = "<a target='_blank' ". $id ." href='https://www.facebook.com/sharer/sharer.php?u=". $options['url'] ."&t=" . $options['title'].  "' class='".$options['class-prefix']. $options['content'][$btn]['class'] ." '> </a>";
            break;
          case 'twitter':
            $button = "<a target='_blank' ". $id ." href='https://twitter.com/intent/tweet?text=". $options['title'] ."&source=sharethiscom&related=sharethis&url=" . $options['url'] . "' class='".$options['class-prefix']. $options['content'][$btn]['class'] ."'></a>";
            break;
          case 'linkedin':
